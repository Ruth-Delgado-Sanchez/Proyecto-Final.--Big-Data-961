...
1. La carpeta contiene 3 archivos mis que colocaras dentro de tu proyecto.
      I. interfaz_piel.html
      II. Carpeta/tipos con las imágenes:
          Palida.jpg
          Clara.jpg
          Dorada.jpg
          Triguena.jpg
          Oscura.jpg
      III. interfaz_piel.js
...
4. Debes instalar la extension "Live Server" en caso de no tenerla, te permite:
    - evitar bloqueos de cámara
    - evitar restricciones de seguridad del navegador
    - ejecutar el modelo sin errores
      
5. Ejecuta el archivo HTML con Live Server 
