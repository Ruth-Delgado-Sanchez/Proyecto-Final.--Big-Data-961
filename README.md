...
1. Es necesario descargar los 3 archivos.
  La carpeta de tu proyecto debe contener:
...
4. Ejecuta el archivo HTML con Live Server 
    ...
    http://127.0.0.1:5500/
5. Permitir el uso de la camara: El navegador te pedirá autorización.
Selecciona "Permitir" para que el modelo pueda analizar tu rostro.
